              ...
              <tbody>
                {this.state.customers.map(c =>
                  <tr>
                    ...
                    <td>{c.email}</td>
                    <td><Button variant="danger" onClick={() => this.unregistercustomer(c._id)}>Unregister</Button> <Link to={`/customeraccount/${c._id}`}><Button variant="warning">View Profile</Button></Link> <Button variant="success" href="/videoChat" >Video Call</Button> <Link to={`/messengert/${c._id}`}><Button variant="success">Message</Button></Link> <Button variant="primary" onClick={() => this.showpayments(c._id)}>Payments</Button></td>
                  </tr>
                )}
