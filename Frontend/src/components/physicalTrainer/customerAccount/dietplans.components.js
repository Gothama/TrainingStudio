...
const siAPI = axios.create({
    baseURL: `http://localhost:9020/dietplan/delete`
})

const siAPI1 = axios.create({
    baseURL: `http://localhost:9020/dietplan/getalldietplans/`
})

const siAPI2 = axios.create({
    baseURL: `http://localhost:9020/dietplan/ndietplan/`
})
const siAPI3= axios.create({
    baseURL: `http://localhost:9020/email/newdietplanadded/`
})
